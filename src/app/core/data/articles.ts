...
export const ARTICLES: Article[] = [
  {
    ...
    excerpt:
      'Una reflexión sobre las condiciones reales que deberían sostener un diálogo político frente a conflictos prolongados y demandas sociales urgentes.',
  ...
  },
  {
    ...
    excerpt:
      'Una mirada crítica sobre el deterioro de lo público, la responsabilidad colectiva y las formas cotidianas en que se debilita aquello que debería cuidarse.',
    category: 'Opinión',
  ...
  },
  {
    ...
    excerpt:
      'Un análisis sobre la erosión institucional, los riesgos para la democracia boliviana y las tensiones que amenazan su continuidad efectiva.',
    category: 'Opinión',
